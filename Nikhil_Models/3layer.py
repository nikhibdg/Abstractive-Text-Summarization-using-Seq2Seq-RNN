...
with tf.Session() as sess:
    ...
    cells = [tf.contrib.rnn.LSTMCell(64, initializer=lstm_initializer) for _ in range(num_layers)]
    ...
    for epoch in range(epochs):
        ...
        # saver = tf.train.Saver()
        save_path = saver.save(sess, "drive/ML_FINAL/saved_model/model.ckpt".format(epoch))
